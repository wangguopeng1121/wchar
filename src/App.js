...
import Aaa from './componente/Aaa';
// 引入antd
    ...
    <Router>
           ...
           <Header className="header"  style={{  background: 'white' }}  > 
                  <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['1']}  style={{fontSize:20}}  > 
                    ...
                    <Menu.Item key="2"><Link to="/airy"></Link></Menu.Item>
                    <Menu.Item key="2"><Link to="/waterz"></Link></Menu.Item>
                    <Menu.Item key="2"><Link to="/watery"></Link></Menu.Item>
                    <Menu.Item key="2"><Link to="/software"></Link></Menu.Item>
                    <Menu.Item key="2"><Link to="/safetyz"></Link></Menu.Item>
                  </Menu>
                  </Header>
             </Layout>
          {
